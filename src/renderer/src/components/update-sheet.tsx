...
function Available({
  ...
  return (
    <motion.div {...fade} className="flex h-full flex-col">
      <header className="flex shrink-0 items-center justify-between gap-3 border-b px-8 py-5">
      ...
      <div className="schema-scroll min-h-0 flex-1 overflow-y-auto px-8 py-6">
        <div className="mx-auto flex w-full max-w-2xl flex-col gap-4">
          ...
          {state.releaseNotes ? (
            <pre className="rounded-xl border bg-muted/30 p-4 text-sm leading-relaxed whitespace-pre-wrap break-words">
              {state.releaseNotes}
            </pre>
          ) : (
